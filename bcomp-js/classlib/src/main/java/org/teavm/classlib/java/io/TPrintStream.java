//Source: https://github.com/konsoletyper/teavm/blob/master/classlib/src/main/java/org/teavm/classlib/java/io/TPrintStream.java
/*
...
public class TPrintStream extends TFilterOutputStream {
	...
	public TPrintStream format(Locale locale, String format, Object ...args){
		print(TString.format(locale, format, args));
		return this;
	}
